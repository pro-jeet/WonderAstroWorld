//
//  testAstroCardViewModelUnitTests.swift
...
final class testAstroCardViewModelUnitTests: XCTestCase {
    ...
    func testGetData() throws {
        ...
        let cardViewModel = AstroCardViewModel()
        
        cardViewModel.getData(urlString: mockURLString, key: "", completion: { uiImage, error in
